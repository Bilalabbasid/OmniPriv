...
export const solutions: Solution[] = [
    ...
    // ─── 2. Password & Credential Management ──────────────────────
    {
        ...
        features: [
            ...
            { name: "Password Groups", description: "All accounts within a group automatically share the same password value — updates propagate instantly to every linked member account", icon: Layers },
            ...
            { name: "Bulk Onboarding", description: "Mass enrollment of privileged entities with automatic provisioning of all built-in accounts, privileges, rights, and permissions to the organizational standard", icon: Database },
